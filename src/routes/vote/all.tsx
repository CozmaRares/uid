          ...
          {votes.map(vote => (
            <li key={vote.id}>
              ...
              {/*<Card className="h-full w-full">
                <Link
                  className="focus-ring flex h-full w-full cursor-pointer flex-row items-center justify-between rounded-xl p-6 text-left transition-colors hover:bg-primary/40"
                  href={`/vote/${vote.id}`}
                >
                  ...
                  <div>
                    ...
                    <span className="opacity-80">
                      {formatCompactNumber(vote.necessaryVotes)}
                    </span>
                  </div>
                </Link>
              </Card>*/}
